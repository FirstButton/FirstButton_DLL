...
'-------------------------------------------------------------------------------------------'
<ComClass(FBClass1.ClassID, FBClass1.InterfaceId, FBClass1.EventsID)> _
Public Class FBClass1
    Public Const ClassID As String = "14568BD0-375F-436b-A242-25F3F7986250"
    Public Const InterfaceId As String = "6E4E7F6A-9905-46f2-96E2-62AD4B36C4B8"
    Public Const EventsID As String = "CA14892B-6833-4cca-8CA6-05D5DC42A868"

    Public Sub New()
        MyBase.New()
    End Sub
    'brand-dependent variables'
    Public logo_new_guid As String
    Public logo_new_guid_2 As String
    Public logo_brand_name As String
    Public logo_company_name As String
    Public logo_company_url As String
    Public logo_toolbar_install_pos As String
    Public logo_IE7_toolbar_install_pos As String
    Public logo_default_target_pos As Integer
    Public logo_IE7_default_target_pos As Integer
    Public logo_use_skipahead_logic As Boolean         'added 02/26/2011'
    Public logo_IE7_use_skipahead_logic As Boolean     'added 02/26/2011'
    Public logo_install_favorite As Boolean
    Public logo_install_tools As Boolean

    Public logo_dest_path As String      'path to source module for icons'
    Public logo_icon_1_value As String   'for use after destination path ex: hoticon | sombreros.exe,1'
    Public logo_icon_2_value As String   '.exe, 2'
    Public logo_icon_3_value As String   '.exe, 3'
    Public logo_icon_4_value As String   '.exe, 4'
    Public logo_icon_5_value As String   '.exe, 5'
    Public logo_icon_6_value As String   '.exe, 6'

    Public logo_error_code As Long
    ...
    Public Function install_button()
        ...
        End If
install_exit:
        Return logo_error_code & " " & logo_error_text
    End Function
...
Private Sub initialize_settings()
    'check parms passed to DLL before processing'
    logo_error_code = 0
    logo_error_text = ""
    logo_error_action = ""
    logo_error_source = ""
   ...
   If logo_install_activity = True Then
     If logo_install_tools = True Then
      If Not logo_new_guid Is Nothing Then
       If logo_new_guid.Length < 38 Then
        logo_error_code = 8
        logo_error_text = "GUID 1 Parameter not 38 Characters in length. Must also include Brackets. See logo_new_guid Parameter."
        Exit Sub
       Else
        If Mid(logo_new_guid.ToString, 1, 1) = "{" Then
          'continue'
        Else
          logo_error_code = 8
          logo_error_text = "GUID 1 Parameter must include { in first position of string. See logo_new_guid Parameter."
          Exit Sub
        End If
        If Mid(logo_new_guid.ToString, 38, 1) = "}" Then
           'continue'
        Else
          logo_error_code = 8
          logo_error_text = "GUID 1 Parameter must include } in last (38th) position of string. See logo_new_guid Parameter."
          Exit Sub
        End If
       End If 'check for length of 38'
     End If 'check for logo new guid is nothing'
    End If  'check for if logo install tools is true'
   If Not logo_new_guid_2 Is Nothing Then
    If logo_new_guid_2.Length < 38 Then
      logo_error_code = 8
      logo_error_text = "GUID 2 Parameter not 38 Characters in length. Must also include Brackets." _
      & " See logo_new_guid_2 Parameter."
      Exit Sub
    Else
      If Mid(logo_new_guid_2.ToString, 1, 1) = "{" Then
        'continue'
      Else
        logo_error_code = 8
        logo_error_text = "GUID 2 Parameter must include { in first position of string. See logo_new_guid_2 Parameter."
        Exit Sub
      End If
      If Mid(logo_new_guid_2.ToString, 38, 1) = "}" Then
         'continue'
      Else
        logo_error_code = 8
        logo_error_text = "GUID 2 Parameter must include } in last (38th) position of string. See logo_new_guid_2 Parameter."
        Exit Sub
      End If
    End If
   Else
        ...
        logo_error_text = "GUID 2 Parameter must include } in last (38th) position of string. See logo_new_guid_2 Parameter."
   End If
   If Not logo_brand_name Is Nothing Then
    If logo_brand_name.Length > 1 Then
       'continue'
    Else
      logo_error_code = 8
      logo_error_text = "Brand Name is required.  See logo_brand_name Parameter."
      Exit Sub
    End If
   Else
      logo_error_code = 8
      ...
      Exit Sub
   End If
   If Not logo_company_name Is Nothing Then
    If logo_company_name.Length > 1 Then
       'continue'
    Else
      logo_error_code = 8
      logo_error_text = "Company Name is required.  See logo_company_name Parameter."
      Exit Sub
    End If
   Else
      logo_error_code = 8
      ...
      Exit Sub
   End If
   If Not logo_company_url Is Nothing Then
    If logo_company_url.Length > 1 Then
      'continue'
    Else
      logo_error_code = 8
      logo_error_text = "Company URL is required.  See logo_company_url Parameter."
      Exit Sub
    End If
   Else
    logo_error_code = 8
    ...
    Exit Sub
   End If
   If Not logo_toolbar_install_pos Is Nothing Then
    If logo_toolbar_install_pos.ToString.Length > 0 Then
       'continue'
       If logo_toolbar_install_pos.GetType.ToString = "System.Int32" Or _
          logo_toolbar_install_pos.GetType.ToString = "System.String" Then
          If IsNumeric(logo_toolbar_install_pos.ToString) Then
            logo_default_target_pos = CInt(logo_toolbar_install_pos.ToString)
          Else
            logo_error_code = 8
            logo_error_text = "logo_toolbar_install_pos Parameter must be a numeric value. " _
            & "No quotes, commas, or alphabetic characters."
            Exit Sub
          End If
       End If
    Else
       logo_error_code = 8
       logo_error_text = "logo_toolbar_install_pos Parameter is required. " _
       & "Numeric offset position for button to appear in (IE6)"
       Exit Sub
    End If
   Else
    logo_error_code = 8
       ...
       Exit Sub
   End If
   If Not logo_IE7_toolbar_install_pos Is Nothing Then
    If logo_IE7_toolbar_install_pos.ToString.Length > 0 Then
       'continue'
      If logo_IE7_toolbar_install_pos.GetType.ToString = "System.Int32" Or _
         logo_IE7_toolbar_install_pos.GetType.ToString = "System.String" Then
         If IsNumeric(logo_IE7_toolbar_install_pos.ToString) Then
            logo_IE7_default_target_pos = CInt(logo_IE7_toolbar_install_pos.ToString)
         Else
            logo_error_code = 8
            logo_error_text = "logo_ie7_toolbar_install_pos Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
       logo_error_code = 8
       logo_error_text = "logo_ie7_toolbar_install_pos Parameter is required. " _
       & " Numeric offset position for button to appear in (IE7+)."
       Exit Sub
    End If
   Else
    logo_error_code = 8
       ...
       & " Numeric offset position for button to appear in (IE7+)."
       Exit Sub
   End If   'check for logo_IE7_toolbar_install_pos is nothing'
   If Not logo_icon_1_value Is Nothing Then
    If logo_icon_1_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_1_value.GetType.ToString = "System.Int32" Or _
         logo_icon_1_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_1_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_1_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_1_value Parameter is required.  " _
      & " Numeric value to source icons from, for the Toolbar Button."
    End If
   Else
      logo_error_code = 8
      logo_error_text = "logo_icon_1_value Parameter is required.  " _
      ...
      Exit Sub
   End If
   If Not logo_icon_2_value Is Nothing Then
    If logo_icon_2_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_2_value.GetType.ToString = "System.Int32" Or _
         logo_icon_2_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_2_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_2_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_2_value Parameter is required. " _
      & " Numeric value to source icons from, for the Toolbar Button."
      Exit Sub
    End If
   Else
      ...
      Exit Sub
   End If
   If Not logo_icon_3_value Is Nothing Then
    If logo_icon_3_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_3_value.GetType.ToString = "System.Int32" Or _
         logo_icon_3_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_3_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_3_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_3_value Parameter is required. " _
      & " Numeric value to source icons from, for the Toolbar Button."
      Exit Sub
    End If
   Else
      ...
      Exit Sub
   End If
   If Not logo_icon_4_value Is Nothing Then
    If logo_icon_4_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_4_value.GetType.ToString = "System.Int32" Or _
         logo_icon_4_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_4_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_4_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_4_value Parameter is required.  " _
      & " Numeric value to source icons from, for the Toolbar Button."
      Exit Sub
    End If
   Else
     ...
     Exit Sub
   End If
   If Not logo_icon_5_value Is Nothing Then
    If logo_icon_5_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_5_value.GetType.ToString = "System.Int32" Or _
         logo_icon_5_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_5_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_5_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_5_value Parameter is required.  " _
      & " Numeric value to source icons from, for the Toolbar Button."
      Exit Sub
    End If
   Else
    ...
    Exit Sub
   End If
   If Not logo_icon_6_value Is Nothing Then
    If logo_icon_6_value.ToString.Length > 0 Then
     'continue'
      If logo_icon_6_value.GetType.ToString = "System.Int32" Or _
         logo_icon_6_value.GetType.ToString = "System.String" Then
         If IsNumeric(logo_icon_6_value.ToString) Then
            'continue'
         Else
            logo_error_code = 8
            logo_error_text = "logo_icon_6_value Parameter must be a numeric value." _
            & " No quotes, commas, or alphabetic characters."
            Exit Sub
         End If
      End If
    Else
      logo_error_code = 8
      logo_error_text = "logo_icon_6_value is required. " _
      & " Numeric value to source icons from, for the Toolbar Button."
      Exit Sub
    End If
   Else
     ...
     Exit Sub
   End If
  Else   'if logo_install_activity = false, only check the GUID field(s)'
   If logo_install_tools = True Then
     If Not logo_new_guid Is Nothing Then
      If logo_new_guid.Length < 38 Then
        'continue'
      ...
      Else
        ...
        End If
      End If  'check for length of 38'
    Else  'if logo new guid is nothing'
     logo_error_code = 8
     logo_error_text = "GUID 1 Parameter not 38 Characters in length. Must also include Brackets. See logo_new_guid Parameter."
     Exit Sub
   End If  'end of check for logo new guid is nothing'
  End If 'end of check for logo_install_tools = True'
    'logo_new_guid_2 is for the toolbar button guid'
   If Not logo_new_guid_2 Is Nothing Then
    If logo_new_guid_2.Length < 38 Then
      logo_error_code = 8
      logo_error_text = "GUID 2 Parameter not 38 Characters in length. Must also include Brackets." _
    ...
    Else
      ...
      Else
        ...
        Exit Sub
      End If
    End If  'end of check for logo new guid 2 being less than 38'
   Else
     logo_error_code = 8
     logo_error_text = "GUID 2 Parameter not 38 Characters in length. Must also include Brackets." _
      & " See logo_new_guid_2 Parameter."
     Exit Sub
   End If   'check for logo_new_guid_2 being nothing'
 End If  'end of check for install activity being true'
    IE7_flag = False
 ...
 '   End If                                '11/10/2013'
    ...
    If Len(logo_dest_path) >= 3 Then
      'continue'
    Else
      logo_error_code = 8
      logo_error_text = "Invalid path for Toolbar Button installation. " _
      & "Verify that logo_dest_path Parameter contains valid path and filename to use for Icons."
      Exit Sub
    End If
    ...
    If logo_use_skipahead_logic = True Then
      logo_use_mapid_logic = True
    Else
      logo_use_mapid_logic = False
    End If
    If logo_IE7_use_skipahead_logic = True Then
      logo_IE7_use_mapid_logic = True
    Else
      logo_IE7_use_mapid_logic = False
    End If
End Sub
...
Private Sub create_favorites()
  ...
  If logo_install_favorite = True Then
    Try
      ...
      PrintLine(logo_file_number, "IconFile=" & logo_app_path)
      ...
      Select Case .dwPlatformId
          ...
          Case 2
              Select Case .dwMajorVersion
                  ...
                  Case 5
                      'either win xp, win xp sp2, or win 2003 server'
                      Select Case .dwMinorVersion
                          Case 0
                              'Windows 2000'                              
                              Me.win2kxp_flag = "Y"
                  ...
                  Case 6
                      ...
                      'logo_check_UAC_flag = True'     '04/12/2015'
                  Case 10
...
Private Sub get_IE_version()
  ...
  If Me.win8_flag = "Y" Then                              '04/14/2012'
    logo_sub_valuename = "svcVersion"                     '04/14/2012'
  Else                                                    '04/14/2012'
    logo_sub_valuename = "Version"                        '04/14/2012'
  End If                                                  '04/14/2012'
  Try
    rk = Microsoft.Win32.Registry.LocalMachine.OpenSubKey(logo_sub_keyname, False)
  Catch
...
Private Sub replace_b4_n_after()
  ...
  Else
   ...
   Else
        cmd_id_compare_value = cmd_id_compare_value_IE7
   End If
  End If   'end of check for IE9 flag'
...
Private Sub check_for_IE7_cmdmapping()
  ...
  End If
End Sub
Private Sub check_toolbar_unlocked()
  logo_IE7_lreturnvalue = 0
...
' 11/10/2013 - added for UAC check in Vista, 7, 8, 10'
  Dim logo_string_ret_length_2 As Integer
...
Private Sub install_reg_entries()
  ...
  logo_nextid_missing_flag = False
  logo_install_add_remove = False
  logo_dest_file = logo_dest_path      'assume that we were passed a valid path and program to point to'
  logo_app_path = logo_dest_path       'to be used in registry entries'
...
install_fav_entry:
  ...
  If IE7_flag = True Then
    SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_1_value.ToString))
    SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_1_value.ToString))
  Else
   If Me.win2kxp_flag = "Y" Then
     If Me.win2000_flag = "Y" Then
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_4_value.ToString))
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_3_value.ToString))
     Else
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_2_value.ToString))
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_1_value.ToString))
     End If
      Else
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_6_value.ToString))
       SetUpKeyValue(HKEY_LOCAL_MACHINE, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_5_value.ToString))
      End If
  End If
  ...
  If IE7_flag = True Then
    SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_1_value.ToString))
    SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_1_value.ToString))
  Else
    If Me.win2kxp_flag = "Y" Then
      If Me.win2000_flag = "Y" Then
        SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_4_value.ToString))
        SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_3_value.ToString))
      Else
        SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_2_value.ToString))
        SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_1_value.ToString))
      End If
    Else
      SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "HotIcon", (logo_app_path & "," & logo_icon_6_value.ToString))
      SetUpKeyValue(HKEY_CURRENT_USER, "Software\Microsoft\Internet Explorer\Extensions\" & logo_new_guid_2, "Icon", (logo_app_path & "," & logo_icon_5_value.ToString))
    End If
  End If
...
Private Sub installation_error()
  logo_error_code = 12
  logo_error_text = "May not have adequate authority to install Toolbar Button"
End Sub
End Class
